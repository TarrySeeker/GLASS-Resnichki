              ...
              >
                {wide ? null : (
                  <>
                    ...
                    {/* На странице бренда мера снимается: строки идут во всю
                        ширину колонки. У .t-lead она зашита в 34em и держит
                        текст читаемым везде, где он отвечает на вопрос; здесь
                        решение принято отдельно. */}
                    <p className={`t-lead ${story ? 'mt-8 t-lead-wide' : 'mt-6'}`}>{page.lead}</p>
                  </>
                )}
                ...
                {'body' in page ? (
                  ...
                  >
                    {page.body.map((par) => (
                      <p
                        key={par}
                        className={`t-lead t-muted ${wide ? 'lg:col-span-4' : ''} ${
                          story ? 't-lead-wide' : ''
                        }`}
                      >
                        {par}
