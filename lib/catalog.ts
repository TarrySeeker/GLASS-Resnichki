 ...
 *
 * СЪЁМКА ОТ 15 АВГУСТА 2026 (marketzone.pro, 54 кадра + одно видео 42 с):
 * предметная, как и архив: крафтовая коробка доставки, коробочка «подарок»,
 * буклет с моделями, бежевые лотки-подарки и белая коробка MERMAID LIGHT.
 * Ни одного портрета — поэтому герой, три лица и кадр в блоке «Категории»
 * остались от прежней съёмки, заменить их этой нечем.
 * Имени линейки, совпадающего с каталогом, ни на одном кадре нет: «PURE
 * COMFORT WEAR», «SOFT AS SILK», «МЯГКИЕ, КАК ШЁЛК», «ОТКРОЙ СВОЮ КРАСОТУ» —
 * это слоганы по краям одной и той же коробки, а не названия. Единственное
 * настоящее имя рядом с логотипом — MERMAID LIGHT, лоток микс 8–14 мм
 * (длины напечатаны на самом лотке), и такой позиции в каталоге нет.
